  ...
  return (
    <div className={`${styles.card} ${open ? styles.open : ""}`}>
      <button
        ...
        aria-label={open ? "Fechar contexto da IA" : "Abrir contexto da IA"}
      >
      ...
      {open && (
        <div className={styles.body}>
          ...
          <p className={styles.text}>
            Este sistema utiliza inteligência artificial para analisar dados
            financeiros e operacionais da Cristália, gerando insights
            estratégicos, alertas inteligentes e recomendações acionáveis para a
            liderança.
          </p>
