      ...
      <div className={styles.wrapper}>
        ...
        {loading ? (
          ...
          <div className={styles.emptyFilter}>
            <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="var(--foreground)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ opacity: 0.3 }}>
            ...
            <h4 className={styles.emptyFilterTitle}>Nenhum resultado para essa combinação</h4>
            <p className={styles.emptyFilterSub}>Tente ajustar os filtros ou limpar a busca.</p>
                ...
                <div className={styles.detailPanel} style={{ borderLeftColor: config.color }}>
                  <div className={styles.detailGrid}>
                    <div>
                      ...
                      <p className={styles.detailText}>{risk.problem || "—"}</p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <p className={styles.detailText}>{risk.recommendation || "—"}</p>
                    </div>
                    <div>
