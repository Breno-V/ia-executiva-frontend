...
export default function LoginError({ error, reset }: ErrorProps) {
  ...
  return (
    <div className="errorContainer">
      ...
      <h1 className="errorTitle">Erro no login</h1>
      <p className="errorDescription">Ocorreu um erro ao carregar a página de login. Tente novamente.</p>
      ...
      <style jsx>{`
        ...
        .errorDescription { opacity: 0.6; margin-bottom: 2rem; max-width: 24rem; }
        ...
        @media (max-width: 480px) { .errorTitle { font-size: 1.25rem; } .errorContainer { padding: 1.5rem; } }
      `}</style>
    </div>
  );
}
