...
export default function RelatoriosError({ error, reset }: ErrorProps) {
  useEffect(() => {
  ...
  return (
    <div className="errorContainer">
      ...
      <h1 className="errorTitle">Erro na página de Relatórios</h1>
      <p className="errorDescription">Não foi possível carregar os relatórios. Tente novamente ou volte ao Dashboard.</p>
