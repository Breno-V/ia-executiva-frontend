...
export default function AlertasError({ error, reset }: ErrorProps) {
  useEffect(() => {
  ...
  return (
    <div className="errorContainer">
      ...
      <h1 className="errorTitle">Erro na página de Alertas</h1>
      <p className="errorDescription">Não foi possível carregar os alertas. Tente novamente ou volte ao Dashboard.</p>
