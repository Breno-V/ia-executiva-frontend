...
export default function GeograficaError({ error, reset }: ErrorProps) {
  useEffect(() => {
  ...
  return (
    <div className="errorContainer">
      ...
      <h1 className="errorTitle">Erro na página Geográfica</h1>
      <p className="errorDescription">Não foi possível carregar o mapa e indicadores. Tente novamente ou volte ao Dashboard.</p>
